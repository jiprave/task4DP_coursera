...
```
[See the complete code for the app]()


## 5. The web app
![](figapp.png "titulo")

In the Figure, the 5 most harmful events for the health of the population are presented (using a variable based on the count by event-year). The user can choose another variable, change the color and position of the bars. [App link](https://idinnov.shinyapps.io/tas4_dp/)
